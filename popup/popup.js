document.addEventListener('DOMContentLoaded', function() {
    ...
    chrome.storage.local.get(['qrText', 'lastQRText'], function(result) {
      ...
      if (result.qrText) {
        ...
        chrome.storage.local.set({ lastQRText: result.qrText }, () => {
          chrome.storage.local.remove(['qrText']);
        });
    ...
    chrome.commands.onCommand.addListener((command) => {
      if (command === "generate-qr") {
        ...
        chrome.storage.local.get(['lastQRText'], function(result) {
